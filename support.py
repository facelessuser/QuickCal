...
CSS = '''
div.quick-cal { padding: 10px; margin: 0; }
.quick-cal h1, .quick-cal h2, .quick-cal h3,
.quick-cal h4, .quick-cal h5, .quick-cal h6 {
    {{'string'|css}}
}
.quick-cal blockquote { {{'comment'|css}} }
.quick-cal a { text-decoration: none; }
'''
...
class QuickCalSupportInfoCommand(sublime_plugin.ApplicationCommand):
    """Support info."""
...
class QuickCalOpenSiteCommand(sublime_plugin.ApplicationCommand):
    """Open site links."""
...
class QuickCalDocCommand(sublime_plugin.WindowCommand):
    """Open doc page."""
...
class QuickCalChangesCommand(sublime_plugin.WindowCommand):
    """Changelog command."""
